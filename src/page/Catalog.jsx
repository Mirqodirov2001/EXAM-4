...
import seven from '../components/assets/images/Group 49.jpg'
import seven1 from '../components/assets/images/Group 50.jpg'
...
import icon1 from '../components/assets/icons/icon-1.svg'
      ...
      <section>
        <div className='container'>
          <div className='pt-[150px]'>
            <ul className='flex gap-[12px] mb-[43px]'>
              <NavLink to='/'>
                {' '}
                <li className='text-[12px] font-normal font-[inter] text-black focus:text-[#42f5da]  hover:text-[#00ff99] cursor-pointer'>
                  Home
                </li>
              </NavLink>
              <li className='text-[12px] font-normal font-[inter] text-black focus:text-[#42f5da]  hover:text-[#00ff99] cursor-pointer'>
            ...
            <div className='flex gap-[72px]'>
              <img
                className=' rounded-md hover:shadow-lg hover:shadow-black/50 mb-[57px]'
                src={seven}
                alt='01'
              />
              <div className='text'>
          ...
          <div className='wrapper mt-[50px] h-[440px] mb-[93px]'>
